...
public class MessageService {
    ...
    private static Pattern URL_REGEXP = Pattern.compile(URL_PATTERN,  Pattern.CASE_INSENSITIVE);
    private static Pattern IMG_REGEXP = Pattern.compile(IMG_PATTERN,  Pattern.CASE_INSENSITIVE);
